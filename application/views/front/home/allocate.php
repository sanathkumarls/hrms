...
<div class='home_menu'><div role='main' class='menu-head main' id='menu-shadow' style='display:none;'>
  ...
  <button type="submit" class="button3"><i class="fa fa-search"></i></button>
...
<div class='side-menu div_mchilds_4' style='display:none;'>
									...
									</div><div class='side-menu div_mchilds_149' style='display:none;'>
                  ...
                  <a href="<?php echo base_url();?>home/project_profile">
                      <li class="clickable_menu single-menu">
                          Project Profile</li></a><br>
                                         ...
                                         <!--
                                           <div class="shortcuts"><h1>Shortcuts</h1><div class="short-text-ctrl">You have not configured your shortcut icons.  <a href="http://localhost/sentrifugo/index.php/viewsettings/2">Click here</a> to configure</div></div>
                                           -->
...
<div id="page-content-wrapper">
   ...
   <!--
    <div class="breadcrumbs"><span class="firstbreadcrumb" onclick="window.location='http://localhost/sentrifugo/index.php'">Home</span> <span class="arrows">&rsaquo;</span> <span>HR</span> <span class="arrows">&rsaquo;</span> <a href="http://localhost/sentrifugo/index.php/employee" >Employees</a> <span class="arrows">&rsaquo;</span> <span>Add</span></div>    </div>
-->
...
//for menu div to be displayed
   ...
   //for grid display view in application
    ...
    var selected_obj = $('li[menu-url="/sentrifugo/index.php/employee/add"]');
...

    {
        ...
        if(controllerName != 'error'){   
                									...
                									selected_obj = $("li[menu-url='http://localhost/sentrifugo/index.php/employee']"); 
    ...
    {   
		...
		selected_obj = $("li[menu-url='http://localhost/sentrifugo/index.php/employee/add']"); 
...
<script type="text/javascript" language="javascript">
            ...
            $(document).ready(function(){
                        ...
                        $('#lastname_orghead').blur(function(){                                   

                            $('#errors-lastname_orghead').remove();                                    

                            if($.trim($(this).val()) == '')

                             { 

							    $(this).parent().append("<span class='errors' id='errors-lastname_orghead'>Please Enter Last Name.</span>");
...

                             {
                                 ...
                                 $('#errors-lastname_orghead').remove();   
                                  ...
                                  $('#lastname_orghead').trigger('keyup');

                                $('#lastname_orghead').trigger('change'); 
                        ...
                        $('#lastname_orghead').keyup(function(){
                             ...
                             { 
                                 ...
                                 if(!expr.test($(this).val()))

                                  {
                                      ...
                                      $(this).parent().append("<span class='errors' id='errors-lastname_orghead'>Please enter valid last name.</span>");
                        ...
                        $('#firstname_orghead').blur(function(){                                   

                            $('#errors-firstname_orghead').remove();                                    

                            if($.trim($(this).val()) == '')

                             { 

							    $(this).parent().append("<span class='errors' id='errors-firstname_orghead'>    </span>");
...

                             {
                                 ...
                                 $('#errors-firstname_orghead').remove();   
                                  ...
                                  $('#firstname_orghead').trigger('keyup');

                                $('#firstname_orghead').trigger('change'); 
                        ...
                        $('#firstname_orghead').keyup(function(){
                        ...
                        $('#employeeId').blur(function(){                                   
                            ...
                            $('#errors-employeeId').remove();                                    

                            if($.trim($(this).val()) == '')

                             { 

							    $(this).parent().append("<span class='errors' id='errors-employeeId'>Identity codes are not configured yet.</span>");
                        ...
                        $('#s2id_emprole').blur(function(){ 

                            $('#errors-emprole').remove();
                            ...
                            if($.trim($('#emprole').val()) == '')

                             {
                                ...
                                $('#emprole').after("<span class='errors' id='errors-emprole'>Please select role.</span>");
                        ...
                        $('#emailaddress').blur(function(){                                   
                            ...
                            if($.trim($(this).val()) == '')
                             ...
                             { 
							    ...
							    $(this).parent().append("<span class='errors' id='errors-emailaddress'>Please Enter Primary Email.</span>");
                             ...
                             { 
                                 ...
                                 if(!expr.test($(this).val()))

                                  {
                                      ...
                                      $(this).parent().append("<span class='errors' id='errors-emailaddress'>Please enter valid email.</span>");
                        ...
                        $('#date_of_joining_head').blur(function(){                                   
                            ...
                            if($.trim($(this).val()) == '')
                             ...
                             { 
							    ...
							    $(this).parent().append("<span class='errors' id='errors-date_of_joining_head'>Please select date of joining.</span>");
...

                             {
                                ...
                                $('#date_of_joining_head').trigger('change'); 
                        ...
                        $('#employeeNumId').blur(function(){                                   

                            $('#errors-employeeNumId').remove();                                    

                            if($.trim($(this).val()) == '')

                             { 

							    $(this).parent().append("<span class='errors' id='errors-employeeNumId'>Please enter the Employee Id.</span>");
...

                             {
                                 ...
                                 $('#errors-employeeNumId').remove();   
                                  ...
                                  $('#employeeNumId').trigger('keyup');

                                $('#employeeNumId').trigger('change'); 
                             ...
                             { 
                                 ...
                                 if(!expr.test($(this).val()))

                                  {
                                      ...
                                      $(this).parent().append("<span class='errors' id='errors-phone'>Please enter only numbers.</span>");
...
<div id="error_message" style="display:none;"></div>
    ...
    <form method="post" action="<?php echo base_url();?>home/search_project">

        <div id="prefetch1">
        <span class="" style="margin-left: 75%">
            <input type="text" name="projectname" id="project_search_box" class="form-control input-lg typeahead" placeholder="Search Projects">
	...
	<div class="separetor-heading" ><span class="" style="margin-left: 38%"><u> Project Profile</u></span></div>
    ...
    foreach ($project->result() as $row) {
        ?>
        <?php $page=$row->Id?>
        <form name="projectinfo" id="formid" action="<?php echo base_url() ?>home/update_project/<?php echo $row->Id ?>/2"
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <input type="text" onChange="enable()" name="ProjectCode<?php echo $row->Id ?>"
                           id="firstname_orghead"
                           value="<?php echo $row->ProjectCode ?>"
            ...
            <div class="new-form-ui">
                ...
                <label class="required">OEM </label>

                <div class="division">
                    <input type="text" onChange="enable()" name="Oem<?php echo $row->Id ?>"
                           id="lastname_orghead"
                           value="<?php echo $row->Oem ?>" maxLength="50" required>
            ...
            $classname=$this->Main->getclassname($row->Class);
            ?>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <select name="Class<?php echo $row->Id ?>" id="prefix_id" onChange="enable()" required>
                        <option value="<?php echo $row->Class ?>" label="<?php echo $classname ?>">
                            <?php echo $classname ?>
                        </option>
                        <?php
                        foreach($class->result() as $classes)
                        {
                            if($classname != $classes->ClassName)
                            {
                                ?>

                                <option value="<?php echo($classes->ClassId)?>" label="<?php echo($classes->ClassName)?>"><?php echo($classes->ClassName)?></option>
                            <?php  }  }?>
            ...
            <div class="new-form-ui">
                ...
                <label class="required">Part Category </label>

                <div class="division">
                    <input type="text" onChange="enable()" name="PartCategory<?php echo $row->Id ?>" id=""
                           value="<?php echo $row->PartCategory ?>" class="formDataElement"
                           required>
                </div>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <input type="text" onChange="enable()" name="Division<?php echo $row->Id ?>" id=""
                           value="<?php echo $row->Division ?>"
                           class="formDataElement"></div>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <input type="text" onChange="enable()" name="Contact<?php echo $row->Id ?>" id="" value="<?php echo $row->Contact ?>"
                           class="formDataElement"></div>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <input type="text" onChange="enable()" name="StartDate<?php echo $row->Id ?>"
                           id="date_of_birth" value="<?php echo $row->StartDate ?>"
                           class="brdr_none"
                           readonly onfocus="this.blur()" required>
                </div>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <input type="text" onChange="enable()" name="EndDate<?php echo $row->Id ?>"
                           id="date_of_joining_head" value="<?php echo $row->EndDate ?>"
                           class="brdr_none" readonly
                           onfocus="this.blur()" required></div>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                    <select name="Status<?php echo $row->Id ?>" id="prefix_id" onChange="enable()" required>
                        <option value="<?php echo $row->Status ?>" label="<?php echo $row->Status ?>">
                            <?php
                            if ($row->Status == 1)
                                echo "Active";
                            else
                        ...
                        <?php if ($row->Status == 0) { ?>
                            <option value="1" label="Active">Active
                            </option>
                        <?php } ?>
                        <?php if ($row->Status == 1) { ?>
                            <option value="0" label="Inactive">Inactive
                            </option>
                        <?php } ?>
                    </select>
            ...
            <div class="new-form-ui">
                ...
                <div class="division">
                                                                    <textarea onChange="enable()"
                                                                            name="ProjectDescription<?php echo $row->Id ?>"
                                                                            id="ProjectDescription" rows="10"
                                                                            cols="50"></textarea>
<script>
    document.getElementById("ProjectDescription").value = "<?php echo $row->ProjectDescription;?>";
    ...
    <br>
        ...
        <table id="t01">
            ...
            <!--if num >0 of allocated hours display the list-->

            <?php
            if($allocatedhours -> num_rows() > 0)
            {
                ...
                <?php
                $i=0;
                foreach($allocatedhours->result() as $row1)
                {
                ?>
            ...
            <tr>
                <td>
                    <?php
                    $this->load->model('Main');
                    $departmentname=$this->Main->getdepartmentname($row1->DepartmentId);
                    $department=$row1->DepartmentId;
                    ?>
                    <select disabled>

                                <option value="<?php echo $row1->DepartmentId ?>" label="<?php echo $row1->DepartmentId ?>"><?php echo $departmentname?></option>
                    </select>

                </td>
                <td>

                    <input type="text" id="estimatedhours<?php echo $row1->Id?>" name="AllocatedHours<?php echo $row1->Id ?>" value="<?php echo $row1->AllocatedHours?>"  onchange="cal<?php echo $row1->Id?>()" onmouseover="cal<?php echo $row1->Id?>()" onmouseleave="cal<?php echo $row1->Id?>()" onmouseout="cal<?php echo $row1->Id?>()" value="0" class="input1" disabled>


                </td>
                <td>
                    <input type="text" id="additionalhours<?php echo $row1->Id?>" name="AdditionalHours<?php echo $row1->Id ?>"  value="<?php echo $row1->AdditionalHours?>" onchange="cal<?php echo $row1->Id?>()" onmouseover="cal<?php echo $row1->Id?>()" onmouseleave="cal<?php echo $row1->Id?>()" onmouseout="cal<?php echo $row1->Id?>()" value="0" class="input1" >
                </td>
                <td>
    ...
    <script>
        (function cal<?php echo $row1->Id?>() {
            var a=0;
            var b=0;
            var c=0;
            a=document.getElementById("estimatedhours<?php echo $row1->Id?>").value;
            b=document.getElementById("additionalhours<?php echo $row1->Id?>").value;
            c = parseInt(a) + parseInt(b);
            document.getElementById("totalhours<?php echo $row1->Id?>").value = c;
        })();
        function cal<?php echo $row1->Id?>() {
            var a=0;
            var b=0;
            var c=0;
            document.getElementById('submitbutton<?php echo $row1->Id?>').disabled =false;
            a=document.getElementById("estimatedhours<?php echo $row1->Id?>").value;
            b=document.getElementById("additionalhours<?php echo $row1->Id?>").value;
            c = parseInt(a) + parseInt(b);
            document.getElementById("totalhours<?php echo $row1->Id?>").value = c;
...
<div id="countriesContainer"  style="display: none; overflow: auto;">
		...
		<div class="heading">
			...
			<img src="<?php echo base_url()?>media/images/close.png" name="" align="right"
...
<div id="prefixContainer"  style="display: none; overflow: auto;">
	...
	<div class="heading">
	    ...
	    <img src="<?php echo base_url()?>media/images/close.png" name="" align="right" border="0" hspace="3" vspace="5" class="closeAttachPopup" style="margin: -24px 8px 0 0;"> </a>
...
<script language='javascript'>
	...
	<div style="height: 20px;">&nbsp;</div>
        ...
        <div class="copytxt">
        	...
        	<div class="copy-center"><span class="copy_left">&copy; <?php echo date("Y").' '.SiteName; ?> | All Rights Reserved</span></div>
			...
			<!--
				<div class="footerdivbg"> 
                    ...
                    <!-- Added by sapplica Here we are displaying the recently clicked tabs by the user 		
						...
						<div class="recentviewd"><label id="recentviewtext">Recently viewed</label><ul><li><span id="redirectlink"  title = "Leave Request" onclick ="redirecttolink('leaverequest/index','');">Leave Request</span><a href="javascript:void(0);" onClick="closetab(this,'leaverequest')"></a></li><li><span id="redirectlink"  title = "Employees-Add" onclick ="redirecttolink('employee/add','');">Employees-Add</span><a href="javascript:void(0);" onClick="closetab(this,'employee')"></a></li><li><span id="redirectlink"  title = "Profile" onclick ="redirecttolink('dashboard/viewprofile','');">Profile</span><a href="javascript:void(0);" onClick="closetab(this,'dashboard')"></a></li></ul></div>
