...
<form name="projectinfo" id="formid" action="<?php echo base_url() ?>home/add_project" method="post" enctype="multipart/form-data" >

	<!--
	
<input type="hidden" name="id" value="" id="id">    <input type="hidden" name="user_id" value="" />	

	<div class="separetor-heading"><span class="">Employee Details</span></div>
...
<!--
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="employee_id" id="employeeNumId" value="EMPP" class="formDataElement" required>            <!--<span id="errors-employeeNumId" class="errors"></span>-->
<!--
        </div>
	...
	<div class="new-form-ui">
	  ...
	  <label class="required">Project Code </label>
		...
		<div class="division">
<input type="text" name="ProjectCode" id="firstname_orghead" value="" maxLength="50" required>
	...
	<div class="new-form-ui">
	  ...
	  <label class="required">OEM </label>
		...
		<div class="division">
<input type="text" name="Oem" id="lastname_orghead" value="" maxLength="50" required>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="Class" id="prefix_id" required>
    <option value=" " label="Select Class">Select Class</option>
    <?php
    foreach($class->result() as $row)
    {
        ?>

            <option value="<?php echo($row->ClassId)?>" label="<?php echo($row->ClassName)?>"><?php echo($row->ClassName)?></option>
        <?php  } ?>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="PartCategory" id="" value="" class="formDataElement" required></div>
     ...
     <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="Division" id="" value="" class="formDataElement" required>
        </div>
        ...
        <div class="division">
<input type="text" name="Contact" id="" value="" class="formDataElement" required></div>
     ...
     <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="StartDate" id="date_of_birth" value="" class="brdr_none" readonly onfocus="this.blur()" required></div>
        ...
        <div class="division">
<input type="text" name="EndDate" id="date_of_joining_head" value="" class="brdr_none" readonly onfocus="this.blur()" required></div>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="Status" id="prefix_id" required>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
            <textarea name="ProjectDescription" id="ProjectDescription" rows="10" cols="50" required></textarea>
