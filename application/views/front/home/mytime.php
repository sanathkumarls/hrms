...
<div id="content"><div class="tour_aboutHrms"></div>
    ...
    <div class='home_menu'><div role='main' class='menu-head main' id='menu-shadow' style='display:none;'>
            ...
            <ul id='main_ul' class='menu flex'>
                ...
                <li id='main_parent_143'   super-parent = 'main_parent_143' class = 'clickable_menu -main tour_service link-selected' menu-url ='' for-childs = 'div_mchilds_143' selected-class = ''>
                ...
                <li >
                    ...
                    <form method="post" action="<?php echo base_url();?>home/search">
                        ...
                        <div id="prefetch">
                            ...
                            <button type="submit" class="button6"><i class="fa fa-search"></i></button>
...
<!--
                                                <div class="container">
                                                    ...
                                                    <input id="datepicker" onchange="lastDate()"></input>
                                                    <button type="button" class="btn btn-primary" onclick="lastDate()">
                                                        Change Date
                                                    </button>
                                                </div>
                                                ...
                                                <div class="bootstrap.container">
                                                    <input type="text" id="datepicker" onchange="lastDate()" style="height: 20px;">
...
<form action="<?php echo base_url() ?>home/save_timesheet" method="post">
    <?php
                                                    ...
                                                    <table id="t01">
                                                        <tr>
                                                            ...
                                                            <th>OEM</th>
                                                            <th>Step</th>
                                                            <th>Mon-<span id="day1"></span></th>
                                                            <th>Tue-<span id="day2"></span></th>
                                                            <th>Wed-<span id="day3"></span></th>
                                                            <th>Thu-<span id="day4"></span></th>
                                                            <th>Fri-<span id="day5"></span></th>
                                                            <th>Sat-<span id="day6"></span></th>
                                                        </tr>
                                            ...
                                            foreach ($data['project'.$i]->result() as $row) {
                                                ?>
                                                                    ...
                                                                    <option value="<?php echo $row->ProjectCode?>"><?php echo $row->ProjectCode?></option>
                                                                    <?php  } }?>
                                                                </select>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input name="monday" id="monday" hidden>
                                                                <input name="tuesday" id="tuesday" hidden>
                                                                <input name="wednesday" id="wednesday" hidden>
                                                                <input name="thursday" id="thursday" hidden>
                                                                <input name="friday" id="friday" hidden>
                                                                <input name="saturday" id="saturday" hidden>
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st1" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot1" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb1" placeholder="NB" onchange="enable()">
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st2" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot2" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb2" placeholder="NB" onchange="enable()">
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st3" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot3" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb3" placeholder="NB" onchange="enable()">
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st4" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot4" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb4" placeholder="NB" onchange="enable()">
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st5" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot5" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb5" placeholder="NB" onchange="enable()">
                                                            </td>
                                                            <td>
                                                                <input class="input-small" name="st6" placeholder="ST" onchange="enable()">
                                                                <input class="input-small" name="ot6" placeholder="OT" onchange="enable()">
                                                                <input class="input-small" name="nb6" placeholder="NB" onchange="enable()">
                                                            </td>
...
<script id="rendered-js">
                                                    ...
                                                    function lastdateInit(){
                                                        ...
                                                        document.getElementById("tuesday").value = tueDay;
                                                        document.getElementById("day3").innerHTML = wedDay;
                                                        document.getElementById("wednesday").value = wedDay;
                                                        document.getElementById("day4").innerHTML = thuDay;
                                                        document.getElementById("thursday").value = thuDay;
