                        ...
                        $('#firstname_orghead').blur(function(){                                   
                            ...
                            if($.trim($(this).val()) == '')
                             ...
                             { 
							    ...
							    $(this).parent().append("<span class='errors' id='errors-firstname_orghead'>Please Enter First Name .</span>");
                             ...
                             { 
                                 ...
                                 if(!expr.test($(this).val()))

                                  {
                                      ...
                                      $(this).parent().append("<span class='errors' id='errors-firstname_orghead'>Please enter valid first name.</span>");
...
<form name="organisationinfo" id="formid" action="<?php echo base_url() ?>home/add_employee" method="post" enctype="multipart/form-data" >
...
<input type="text" name="employeeId" id="employeeId" value="EMPP" class="formDataElement" readonly onfocus="this.blur()">            <span id="errors-employeeId" class="errors"></span>
    ...
    <div class="separetor-heading" ><span class="" style="margin-left: 38%"><u>Personal Section</u></span></div>
	 ...
	 <div class="new-form-ui">
        ...
        <div class="division">
<select name="initial" id="prefix_id" required>
    <option value="" label="Select Prefix">Select Prefix</option>
	...
	<div class="new-form-ui">
	  ...
	  <label class="required">First Name </label>
		...
		<div class="division">
<input type="text" name="fname" id="firstname_orghead" value="" maxLength="50" required>			
	...
	<div class="new-form-ui">
	  ...
	  <label class="">Middle Name </label>
		...
		<div class="division">
<input type="text" name="mname" id="firstname_orghead1" value="" maxLength="50">			
	...
	<div class="new-form-ui">
	  ...
	  <label class="required">Last Name </label>
		...
		<div class="division">
<input type="text" name="lname" id="lastname_orghead" value="" maxLength="50" required>			
    ...
    <div class="new-form-ui">
        ...
        <label class="required">Maritial Status </label>

        <div class="division">
<select name="mstatus" id="prefix_id" required>
    <option value="" label="Select Prefix">Select Status</option>
    ...
    <option value="Divorced" label="Divorced">Divorced</option>
     ...
     <div class="new-form-ui">
        ...
        <div class="division">
<select name="nationality" id="prefix_id" required>
    <option value="" label="Select Prefix">Select Country</option>
    <?php 
	foreach($country->result() as $row)
	{
		?>
    <option value="<?php echo($row->name)?>" label="<?php echo($row->name)?>"><?php echo($row->name)?></option>
    <?php } ?>
</select>                        
     ...
     <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="dob" id="date_of_birth" value="" class="brdr_none" readonly onfocus="this.blur()" required></div>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="gender" id="prefix_id" required>
    <option value="" label="Select Prefix">Select Gender</option>
    ...
    <option value="Others" label="Others">Others</option>
        ...
        <div class="division">
<input type="text" name="pnumber" id="phone" value="" maxlength="10" class="formDataElement" required></div>
      ...
      <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="pemail" id="emailaddress" value="" class="formDataElement" required></div>
        ...
        <div class="division">
<input type="text" name="snumber" id="phone" value="" maxlength="10" class="formDataElement"></div>
      ...
      <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="semail" id="emailaddress" value="" class="formDataElement"></div>
   ...
   <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="aadhar" id="phone" value="" maxlength="12" class="formDataElement" required></div>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="pan" id="" value="" maxlength="10" class="formDataElement" required></div>
        ...
        <div class="division">
<input type="text" name="acnumber" id="phone" value="" maxlength="16" class="formDataElement" required></div>
        ...
        <div class="division">
<input type="text" name="passport" id="" value="" maxlength="10" class="formDataElement"></div>
	...
	<div class="division">
<textarea name="ehistory" id="description" rows="10" cols="50"></textarea></div>
...
<div class="new-form-ui textareaheight">
	...
	<div class="division">
<textarea name="address" id="description" rows="10" cols="50" required></textarea></div>
    ...
    <div class="separetor-heading"><span class="" style="margin-left: 38%"><u>Work Section</u></span></div>
       ...
       <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="doj" id="date_of_joining_head" value="" class="brdr_none" readonly onfocus="this.blur()" required></div>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="estatus" id="jobtitle_id" required >
    <option value="" label="Select Employment Status">Select Employment Status</option>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="role" id="emprole" class="formDataElement" required>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="etype" id="jobtitle_id" required >
    <option value="" label="Select Employment Type">Select Employment Type</option>
    <option value="Permanent" label="Permanent">Permanent</option>
    <option value="Contract" label="Contract">Contract</option>
</select>                                 <!--<span class="errors" id="errors-jobtitle_id">Job titles are not configured yet.</span>-->
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="designation" id="position_id">
    <option value="" label="Select a Position">Select A Designation</option>
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="department" id="position_id">
    <option value="" label="Select a Position">Select A Department</option>
    <?php
    ...
    <div class="new-form-ui">
        ...
        <div class="division">
<select name="billing" id="position_id" required>
    <option value="" label="Select a Position">Select a Billing Type</option>
    <option value="Billing" label="Billing">Billing</option>
    <option value="Non Billing" label="Non Billing">Non Billing</option>
</select>                               <!--  <span class="errors" id="errors-position_id">Positions are not configured yet.</span>-->
    ...
    <div class="separetor-heading"><span class="" style="margin-left: 38%"><u>Other Details</u></span></div>
     ...
     <div class="new-form-ui">
        ...
        <div class="division">
<input type="text" name="minumber" id="" value="" maxlength="10" class="formDataElement"></div>
...
<input type="submit" name="submit" id="submitbutton" value="Save">		<button type="button" id="btn_cancel" name="add_org_head" >Cancel</button>
