                                                ...
                                                $(document).ready(function(){
                                                    ...
                                                    $('#lastname_orghead').blur(function(){
...

                                                        {
                                                            ...
                                                            $(this).parent().append("<span class='errors' id='errors-lastname_orghead'>Please Enter OEM .</span>");
                                                    ...
                                                    $('#firstname_orghead').blur(function(){
...

                                                        {
                                                            ...
                                                            $(this).parent().append("<span class='errors' id='errors-firstname_orghead'>Please Enter Project Code .</span>");
...
<span class="" style="margin-left: 75%">
                                            ...
                                            <div class="total-form-controller">
                                                ...
                                                <div id="error_message" style="display:none;"></div>
                                                    ...
                                                    <div class="separetor-heading"><span class=""><u>Project Profile</u></span></div>
                                                ...
                                                <div class="separetor-heading" ><span class="" style="margin-left: 35%"><u>Number Of Projects (<?php echo $num?>)</u></span></div>
                                                    ...
                                                    {
                                                        $data['pid'.$i]=$row->ProjectId;
                                                        $i++;
                                                    }
                                                    for ($j=1;$j<=$num;$j++)
                                                    {
                                                        $data['project'.$j] =$this->Project->selectproject($data['pid'.$j]);
                                                    }
                                                        for($i=1;$i<=$num;$i++) {
                                                            ...
                                                            foreach ($data['project'.$i]->result() as $row) {
                                                                ?>
                                                <form name="projectinfo" id="formid" action="<?php echo base_url() ?>home/update_project/<?php echo $row->Id?>/1" method="post" enctype="multipart/form-data" >

                                                                <div class="separetor-heading" >
                                                                    <span class=""style="margin-left: 38%"><u> Project (<?php echo $i ?>)</u></span>
                                                                </div>


                                                                <div class="new-form-ui" <?php if($i>=3) echo 'style="margin-left:30px"'?>>

                                                                    <label class="required">Project Code </label>

                                                                    <div class="division">
                                                                        <input type="text" name="ProjectCode<?php echo $row->Id?>" onchange="enable<?php echo $row->Id?>()"
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="Oem<?php echo $row->Id?>" onchange="enable<?php echo $row->Id?>()"
                                                                               id="lastname_orghead"
                                                    ...
                                                    ?>
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <select name="Class<?php echo $row->Id?>" id="prefix_id" onchange="enable<?php echo $row->Id?>()" required>
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="PartCategory<?php echo $row->Id?>" id="" onchange="enable<?php echo $row->Id?>()"
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="Division<?php echo $row->Id?>" id="" onchange="enable<?php echo $row->Id?>()"
                                                                ...
                                                                <div class="new-form-ui" <?php if($i>=3) echo 'style="margin-left:30px"'?>>
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="Contact<?php echo $row->Id?>" id="" value="<?php echo $row->Contact ?>" onchange="enable<?php echo $row->Id?>()"
                                                                               class="formDataElement"></div>
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="StartDate<?php echo $row->Id?>" onchange="enable<?php echo $row->Id?>()"
                                                                               id="date_of_birth<?php echo $row->Id?>" value="<?php echo $row->StartDate ?>"
                                                                               class="brdr_none"
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        $(document).ready(function(){
                                                            ...
                                                            $('#date_of_birth<?php echo $row->Id?>').datepicker({
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <input type="text" name="EndDate<?php echo $row->Id?>" onchange="enable<?php echo $row->Id?>()"
                                                                               id="date_of_joining_head<?php echo $row->Id?>" value="<?php echo $row->EndDate ?>"
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        $(document).ready(function(){
                                                            ...
                                                            $('#date_of_joining_head<?php echo $row->Id?>').datepicker({
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                        <select name="Status<?php echo $row->Id?>" id="prefix_id" onchange="enable<?php echo $row->Id?>()" required>
                                                                ...
                                                                <div class="new-form-ui">
                                                                    ...
                                                                    <div class="division">
                                                                    <textarea name="ProjectDescription<?php echo $row->Id?>" onchange="enable<?php echo $row->Id?>()"
                                                                              id="ProjectDescription<?php echo $row->Id?>" rows="10"
                                                                              cols="50"></textarea>


                                                                    </div>
                                                                    <script>
                                                                        document.getElementById("ProjectDescription<?php echo $row->Id?>").value = "<?php echo $row->ProjectDescription;?>";
                                                    ...
                                                    <div class="new-form-ui-submit" <?php if($i>=3) echo 'style="margin-left:30px"'?> >
                                                        <input type="submit" name="submit" id="submitbutton<?php echo $row->Id?>" value="Save" hidden>
                                                        <button type="button" id="btn_cancel<?php echo $row->Id?>" name="add_org_head" hidden>Cancel</button>


                                                    </div>
                                                    <script>
                                                        function enable<?php echo $row->Id?>()
                                                        {
                                                            var btn1=document.getElementById('submitbutton<?php echo $row->Id?>');
                                                            btn1.hidden=false;
                                                            var btn2=document.getElementById('btn_cancel<?php echo $row->Id?>');
                                                            btn2.hidden=false;
                                                        }
                                                    ...
                                                    <div class="new-form-ui-submit" <?php if($i>=3) echo 'style="margin-left:30px"'?>>
                                                        ...
                                                        <a href="<?php echo base_url()?>home/project_profile/<?php echo $row->Id?>">
                                                            <input type="button" name="allocate" id="allocate" style="background-color: #0fc397" value="Allocated Hours">
                                                        </a>
